...
<div class="container">
  <h2 style="font-weight: 600;">Gaming</h2>
</div>
...
$sql = " select * from post where catagori = 'Gaming' and visibility = 'Public' ";
...
<a href="../post_view.php?id=<?php echo $row['id']; ?>"> <video src="../../Image/<?php echo $row['p_img'] ?>"  style="height: 500px; width: 100%;" class=""></video></a>
           ...
           ?>
         						...
         						<img src="../../Image/<?php echo $row['p_img'] ?>" style="height: 500px; width: 100%;" class="">
